...
from ..models.analysis_analysis_info import AnalysisAnalysisInfo
from ..models.analysis_analysis_state import AnalysisAnalysisState
from ..models.analysis_annotation_databases_item import AnalysisAnnotationDatabasesItem
from ..models.analysis_capture_kit import AnalysisCaptureKit
from ..models.analysis_ethnicity import AnalysisEthnicity
from ..models.analysis_phenotypes_item import AnalysisPhenotypesItem
from ..models.analysis_reference_genome import AnalysisReferenceGenome
from ..models.analysis_sample_type import AnalysisSampleType
from ..models.analysis_variants_to_keep import AnalysisVariantsToKeep
...
class Analysis:
    ...
    capture_kit: Union[Unset, AnalysisCaptureKit] = AnalysisCaptureKit.VALUE_35000000
    sequencer: Union[Unset, str] = "Illumina"
    sample_type: Union[Unset, AnalysisSampleType] = AnalysisSampleType.GERMLINE
    ...
    reference_genome: Union[Unset, AnalysisReferenceGenome] = AnalysisReferenceGenome.HG19
    variants_to_keep: Union[Unset, AnalysisVariantsToKeep] = AnalysisVariantsToKeep.PASS_ONLY
    ...
    phenotypes: Union[Unset, List[AnalysisPhenotypesItem]] = UNSET
    ...
    analysis_info: Union[Unset, AnalysisAnalysisInfo] = UNSET
    ethnicity: Union[Unset, AnalysisEthnicity] = UNSET
    annotation_databases: Union[Unset, List[AnalysisAnnotationDatabasesItem]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        capture_kit: Union[Unset, AnalysisCaptureKit]
        if isinstance(_capture_kit, Unset):
            capture_kit = UNSET
        else:
            capture_kit = AnalysisCaptureKit(_capture_kit)

        sequencer = d.pop("sequencer", UNSET)

        _sample_type = d.pop("sample_type", UNSET)
        sample_type: Union[Unset, AnalysisSampleType]
        if isinstance(_sample_type, Unset):
            sample_type = UNSET
        else:
            sample_type = AnalysisSampleType(_sample_type)
        ...
        reference_genome: Union[Unset, AnalysisReferenceGenome]
        if isinstance(_reference_genome, Unset):
            reference_genome = UNSET
        else:
            reference_genome = AnalysisReferenceGenome(_reference_genome)

        _variants_to_keep = d.pop("variants_to_keep", UNSET)
        variants_to_keep: Union[Unset, AnalysisVariantsToKeep]
        if isinstance(_variants_to_keep, Unset):
            variants_to_keep = UNSET
        else:
            variants_to_keep = AnalysisVariantsToKeep(_variants_to_keep)
        ...
        for phenotypes_item_data in _phenotypes or []:
            phenotypes_item = AnalysisPhenotypesItem.from_dict(phenotypes_item_data)
        ...
        analysis_info: Union[Unset, AnalysisAnalysisInfo]
        if isinstance(_analysis_info, Unset):
            analysis_info = UNSET
        else:
            analysis_info = AnalysisAnalysisInfo.from_dict(_analysis_info)

        _ethnicity = d.pop("ethnicity", UNSET)
        ethnicity: Union[Unset, AnalysisEthnicity]
        if isinstance(_ethnicity, Unset):
            ethnicity = UNSET
        else:
            ethnicity = AnalysisEthnicity(_ethnicity)

        annotation_databases = []
        _annotation_databases = d.pop("annotation_databases", UNSET)
        for annotation_databases_item_data in _annotation_databases or []:
            annotation_databases_item = AnalysisAnnotationDatabasesItem.from_dict(annotation_databases_item_data)
