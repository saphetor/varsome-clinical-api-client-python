...
from ..models.sample_file_status import SampleFileStatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="SampleFile")
...
class SampleFile:
    ...
    status: Union[Unset, SampleFileStatus] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        status: Union[Unset, SampleFileStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = SampleFileStatus(_status)
        ...
        sample_file.additional_properties = d
        return sample_file
